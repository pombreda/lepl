...
from lepl.regexp.interval import Character, Fragments, IntervalMap
...
class NfaCompiler(LogMixin):
    ...
    def matcher(self, stream):
        ...
        This is unnecessarily inefficient - we just run through different
        Characters when we could combine them into a better lookup.
        '''
